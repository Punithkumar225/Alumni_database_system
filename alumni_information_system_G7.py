...
conn= mysql.connector.connect(host ="localhost", user ="root", passwd = "Punith@1ds20ee051",database = "alumni")
if conn.is_connected():
  print("Alumni Database connected successfully")
...
def introduction():
    msg = '''
          EEE Department Alumni Database Management System
...
def made_by():
    msg = ''' 
            Alumni information system made by       : Punith Kumar S M
            Roll No                                 : 1DS20EE051
            College Name                            : DSCE
            session                                 : 2020-24
...
def main_menu():
    ...
    while True:
      clear()
      print('Department Alumni Database Management System')
      print('*'*100)
